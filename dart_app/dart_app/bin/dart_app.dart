...
void main(){
 ...
 List<String>phoneNumber = ["+88", "01768131685", "01623548967", "01768111286", "01768131685","019945864563"+'\n'];
  print(phoneNumber);

  // there have all number with country code 0 index +88.....

  print('there have all number with 0 index +88'+'\n');
  ...
  // there have all number without 0 index +88..............
